...
class PlugAPI extends EventEmitter3 {
    constructor(authenticationData, callback) {
        ...
        store(this)._convertSecondsToHMS = (seconds) => {
            ...
            const timeRemaining = `${hoursRemaining > 10 ? hoursRemaining : `0${hoursRemaining}`}:${minsRemaining > 10 ? minsRemaining : `0${minsRemaining}`}:${secondsRemaining > 10 ? secondsRemaining : `0${secondsRemaining}`}`;
            ...
            const request = (attempts) => {
                ...
                return got(opts.url, Object.assign(opts, {
                    ...
                    if (err && err.statusCode) {
                        if (Object.is(err.url, 'https://plug.dj/_/rooms/join') && !Object.is(err.statusCode, 404)) {
                            process.nextTick(() => {
     ...
     * @param {String} badge The badgeID to set.
     * @param {RESTCallback} [callback] Callback function
     * @returns {Boolean} If the REST request got queued
     * @since 5.1.0
     *
    ...
    setBadge(badge, callback) {
        if (!store(this)._room.getRoomMeta().slug || !Object.is(typeof badge, 'string') || this.guest) return false;
...
PlugAPI.CreateLogger = util.deprecate(() => { }, 'PlugAPI.CreateLogger is now a noop function and will be removed in V6. Use PlugAPI.logger instead and refer to https://jethrologger.github.io/documentation/jethro-node/ for documentation.');
