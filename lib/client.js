...
class PlugAPI extends EventEmitter3 {
    ...
    createLogger() {
        return util.deprecate(() => {}, 'PlugAPI.createLogger is now a noop function and will be removed in V6. Use PlugAPI.logger instead and refer to https://jethrologger.github.io/documentation/jethro-node/ for documentation.');
    }

    setLogger() {
        return util.deprecate(() => {}, 'PlugAPI.setLogger is now a noop function and will be removed in V6');
    }

    getLoggerSettings() {
        return util.deprecate(() => {}, 'PlugAPI.getLoggerSettings is now a noop function and will be removed in V6. Use PlugAPI.logger instead and refer to https://jethrologger.github.io/documentation/jethro-node/ for documentation.');
    }
