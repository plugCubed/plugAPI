...
var jar = oldRequest.jar();
var request = oldRequest.defaults({
...
* @type {function}
* @param {Array} the playlist to modify
* @private
*/
...
PlugAPI.prototype.grab = function(callback) {
    ...
    that.getActivePlaylist(function(playlist) {
        ...
        var callbackWrapper = function(err, data) {
            if (!err) {
                editPlaylistLength(playlist, true);
            }
            if (typeof callback === 'function') {
...
PlugAPI.prototype.removeSongFromPlaylist = function(pid, mid, callback) {
    ...
    that.getPlaylist(pid, function(playlist) {
        ...
        var callbackWrapper = function(err, data) {
            if (!err)
                editPlaylistLength(playlist, false);
            if (typeof callback === 'function') {
                return callback(err, data);
            }
        };
