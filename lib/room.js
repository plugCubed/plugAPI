...
class Room {
    ...
    getPermissions(other) {
        ...
        permissions.canModStaff = isAdmin || (!Object.is(other.gRole, constants.GLOBAL_ROLES.ADMIN) && (!(me.gRole < constants.GLOBAL_ROLES.MODERATOR && me.role < constants.ROOM_ROLES.BOUNCER) && Math.max(me.role, me.gRole) > Math.max(other.role, other.gRole)));
