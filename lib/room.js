...
class Room {
    constructor() {
        ...
        /**
         * @private
         * @type {{description: string, long_description: string, favorite: boolean, guests: number, hostID: number, hostName: string, id: number, minChatLevel: number, name: string, population: number, slug: string, welcome: string}}
         */
        this.meta = {
            description: '',
            long_description: '',
    ...
    setRoomLongDescription(desc) {
        this.meta.long_description = desc;
    }
